...
<div>
  <label class="text-xs font-medium text-slate-600 mb-7 block">
    Proficiency
  </label>
  <RatingInput
...
<button
  type="button"
  class="absolute top-3 right-3 text-sm text-red-600 hover:underline cursor-pointer"
...
<button
  ...
  px-4 py-2 roundedbg-purple-100 text-purple-800 
  text-sm font-medium hover:bg-purple-200 cursor-pointer "
    ...
    {interests?.map((interest, index) => (
      ...
      >
        ...
        {interests.length > 1 && (
          <button
            type="button"
            className="absolute top-5.5 right-3 text-sm text-red-600 hover:underline cursor-pointer"
